...
public final class SizeUtils {
    ...
    public static int px2dp(final float px) {
        float scale = getScreenWidth() / 360.0f;
    ...
    public static int px2dpH(int px) {
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = ShareApplication.getInstance().getResources().getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenWidth() {
        return ShareApplication.getInstance().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return ShareApplication.getInstance().getResources().getDisplayMetrics().heightPixels;
    }
}
